...
import nodomain.freeyourgadget.gadgetbridge.service.devices.dafit.DaFitDeviceSupport;
            ...
            try {
                switch (gbDevice.getType()) {
                    ...
                    case PINETIME_JF:
                        ...
                        break;
                    case PINETIME_LITE:
                        deviceSupport = new ServiceDeviceSupport(new PineTimeLiteSupport(), EnumSet.of(ServiceDeviceSupport.Flags.BUSY_CHECKING));
                        break;
                    case SG2:
                    ...
                    case SONY_SWR12:
                        ...
                        break;
                    case DAFIT:
                        deviceSupport = new ServiceDeviceSupport(new DaFitDeviceSupport(), EnumSet.of(ServiceDeviceSupport.Flags.BUSY_CHECKING));
                    case WASPOS:
