...
public abstract class AbstractPinetimeLiteOperation<T extends AbstractBTLEDeviceSupport> extends AbstractBTLEOperation<T> {
    protected AbstractPinetimeLiteOperation(T support) {
        super(support);
    }
    ...
    protected void operationFinished() {
        ...
        if (getDevice() != null && getDevice().isConnected()) {
            ...
            try {
                ...
                GB.toast(getContext(), "Error enabling Pinetime Lite notifications, you may need to connect and disconnect", Toast.LENGTH_LONG, GB.ERROR, ex);
            }
        }
    }
